...
var VerblazeContext = createContext(undefined);
var VerblazeProvider = function VerblazeProvider(_ref) {
  ...
  return React.createElement(VerblazeContext.Provider, {
    value: {
...
var useVerblaze = function useVerblaze() {
  var context = useContext(VerblazeContext);
...
export { VerblazeProvider, useVerblaze, vbt };
